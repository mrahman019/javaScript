...
//Equal (loose)
console.log(a == b); // true -> value is same tye is ignored 

//Equal (strict)
console.log(a === b); // false -> value is same bu type is different

// Not Equal (loose)
console.log(a ! = b); // false -> value are equal so not equal is false 
...
Logical OR	True if any one is true Logical NOT	Inverts true/false	!true	false
...
4let age = 10
let output = (age1 >= 18) ? "Adult" : "Minor"
console.log